 ...
 */
public interface MonadCombine<F extends Kind> extends MonadFilter<F>, Alternative<F> {
  /**
   ...
   */
  default <G extends Kind, A> Kind<F, A> unite(Kind<F, Kind<G, A>> fga, Foldable<G> g) {
