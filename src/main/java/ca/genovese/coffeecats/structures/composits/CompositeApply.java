...
public class CompositeApply<F extends Kind, G extends Kind> extends CompositeFunctor<F,G> implements Apply<Kind<F, G>> {
  ...
  @Override
  public <A, B> Kind<Kind<F, G>, B> apply(
      Kind<Kind<F, G>, A> fg_a,
      Kind<Kind<F, G>, Function<A, B>> fg_ab) {
